  ...
  const [posts, setPosts] = useState<Post[]>([
    {
      ...
      content:
        "Given that I only have 1-2 hours a day outside of my current job, I'm trying to make the most of that time. What should I focus on to boost my chances of landing a tech role?",
      likes: 142,
      comments: [],
      shares: 12,
      liked: false,
      ...
      <div className="col-span-12 lg:col-span-6">
        <div className="bg-white rounded-lg border border-gray-300 p-6">
          ...
          <p className="text-gray-600">
            This section is coming soon! The UI has been successfully refactored
            into components.
          </p>
        </div>
      </div>
